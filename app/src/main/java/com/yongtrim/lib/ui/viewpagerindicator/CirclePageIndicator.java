 ...
 */
package com.yongtrim.lib.ui.viewpagerindicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mOrientation = defaultOrientation;//a.getInt(R.styleable.CirclePageIndicator_android_orientation, defaultOrientation);
        mPaintPageFill.setStyle(Style.FILL);
        mPaintPageFill.setColor(defaultPageColor);//a.getColor(R.styleable.CirclePageIndicator_pageColor, defaultPageColor));
...
//        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float threeRadius = mRadius * 4; // <--mRadius * 3;
